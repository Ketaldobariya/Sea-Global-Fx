...
import LayerBlack from "../../../assets/images/layer-black.png"
export default function AccountType() {
  return (
    <section>
      <div className="accounttype-section">
        ...
        <div className="container-xl">
          ...
          <div className="account-type-cards">
            <div
              className="account-bottom-card animate__animated animate__fadeInUp wow"
              data-wow-offset="50"
              data-wow-duration="1.5s"
              data-wow-delay="0.4s"
            >
              <div className="accountType-blackbox-card">
                ...
                <div className="card-bottom-details">
                  ...
                  <div className="card-bottom-allTextStyle">
                    <div className="accountType-text-flex">
                      <p>Minimum Deposit:</p>
                      <span className="text-span-white">$1,000</span>
                    </div>
                    <div className="accountType-text-flex">
                      <p>Commission:</p>
                      <span className="text-span-white">$0</span>
                    </div>
                    <div className="accountType-text-flex">
                      <p>Spread:</p>
                      <span className="text-span-white">From 20 Cents</span>
                    </div>
                    <div className="accountType-text-flex">
                      <p>Leverage:</p>
                      <span className="text-span-white">50 to 500</span>
                    </div>
                    <div className="accountType-text-flex">
                      <p>Currencies</p>
                      <span className="text-span-white">USD</span>
                    </div>
                  </div>
                </div>
            ...
            <div
              className="account-bottom-card center-card-direction animate__animated animate__fadeInUp wow"
              data-wow-duration="1.5s"
              data-wow-offset="50"
              data-wow-delay="0.5s"
            >
              <div className="accountType-blackbox-card">
                ...
                <div className="card-bottom-details">
                  ...
                  <div className="card-bottom-allTextStyle">
                    <div className="accountType-text-flex">
                      <p>Minimum Deposit:</p>
                      <span className="text-span-white">$500</span>
                    </div>
                    <div className="accountType-text-flex">
                      <p>Commission:</p>
                      <span className="text-span-white">$0</span>
                    ...
                    <div className="accountType-text-flex">
                      <p>Spread:</p>
                      <span className="text-span-white">25 Cents</span>
                    </div>
                    <div className="accountType-text-flex">
                      <p>Leverage:</p>
                      <span className="text-span-white">1000</span>
                    </div>
                    <div className="accountType-text-flex">
                      <p>Currencies</p>
                      <span className="text-span-white">USD</span>
